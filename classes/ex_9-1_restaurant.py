...
# make the instance called restaurant from the class. Print the two attributes individually, then call both methods
my_restaurant = Restaurant("The Black Crab", "seafood")
print(f"The name of this restaurant is {my_restaurant.restaurant_name}.")
